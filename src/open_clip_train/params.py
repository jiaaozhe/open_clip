...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto", "csv_aug", "jsonl", "alpha_clip"],
        default="alpha_clip",
    ...
    parser.add_argument("--alpha-lr-scale", type=float, default=100, help="Learning rate scale for alpha conv scale.")
    ...
    parser.add_argument(
        ...
        default=True,
        action="store_true",
        help='Use Custom Clip loss with soft labels.'
    )
